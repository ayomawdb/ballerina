...
public class AnnotationTest {
    ...
    public void testTaintedWithMultiReturn() {
        ...
        BAssertUtil.validateError(result, 1, "tainted value passed to sensitive parameter 'secureIn'", 11, 5);
        BAssertUtil.validateError(result, 2, "tainted value passed to sensitive parameter 'secureIn'", 18, 5);
        BAssertUtil.validateError(result, 3, "tainted value passed to sensitive parameter 'secureIn'", 24, 5);
    }
    ...
    public void testUntaintedWithMultiReturn() {
        ...
        Assert.assertTrue(result.getDiagnostics().length == 4);
        BAssertUtil.validateError(result, 0, "tainted value passed to sensitive parameter 'secureIn'", 6, 5);
        BAssertUtil.validateError(result, 1, "tainted value passed to sensitive parameter 'secureIn'", 12, 5);
        BAssertUtil.validateError(result, 2, "tainted value passed to sensitive parameter 'secureIn'", 17, 5);
        BAssertUtil.validateError(result, 3, "tainted value passed to sensitive parameter 'secureIn'", 23, 5);
    }
}
